...
PI = [[
    168, 67, 95, 6, 107, 117, 108, 89, 113, 223, 135, 149, 23, 240, 216, 9,
...
INV_PI = [[
    164, 162, 169, 197, 78, 201, 3, 217, 126, 15, 210, 173, 231, 211, 39, 91,
...
class DSTU2014Cipher:
    def __init__(self, key, mode):
        ...
        with open(dirname(__file__) + '/dstu_tables', 'rb') as out:
            self.multtable = pickle.load(out)
